...
//var button_auto = document.getElementById("predict-button");
...
function displayChart(data) {
	...
	label = ["ئـ", "ا", "ب", "پ", "ت", "ج", "چ", "ح", "خ", "د", "ر", "ڕ", "ز", "ژ", "س", "ش", "ع", "غ", "ف", "ق", "ڤ", "ک", "گ", "ل", "ڵ", "م", "ن", "هه", "ە", "و", "وو", "ۆ", "ی", "ێ", "ص"];
	if (firstTime == 0) {
...
function displayLabel(data) {
    ...
    kurdish_label = ["ئـ", "ا", "ب", "پ", "ت", "ج", "چ", "ح", "خ", "د", "ر", "ڕ", "ز", "ژ", "س", "ش", "ع", "غ", "ف", "ق", "ڤ", "ک", "گ", "ل", "ڵ", "م", "ن", "هه", "ە", "و", "وو", "ۆ", "ی", "ێ", "ص"];

    let maxIndenx_final = kurdish_label[maxIndex];

	$(".prediction-text").html("Predicting you draw <b>"+maxIndenx_final+"</b> with <b>"+Math.trunc( max*100 )+"%</b> confidence")
}
